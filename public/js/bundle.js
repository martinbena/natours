...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe("pk_test_51MZs2QHxNNVQR7fCme6sa4m9UmD8R39HYIyuX6WwWnKHuRNdNSatVjN0vFjJj4jNDS5yz4l7W7ZThRDDmtISvCyA00NZNGsNPe");
          _context.prev = 1;
          _context.next = 4;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById("password-confirm").value; // async jen proto abychom mohli vymazat inputy pro heslo po dokončení
            _context.next = 7;
